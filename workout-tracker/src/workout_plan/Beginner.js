        ...
        <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-6 mt-4">
              ...
              <div className="w-full sm:w-1/2 lg:w-1/3">
                <img
                  ...
                  className="w-full rounded-lg shadow-md"
                />
                <p className="mt-2 text-center text-gray-600">Glute Bridges</p>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="list-disc pl-6 text-gray-700">
              ...
              <li>
                Russian Twists: 3 sets of 15 reps per side (holding light weight
                if available)
              </li>
            ...
            <div className="flex flex-wrap gap-6 mt-4">
              <div className="w-full sm:w-1/2 lg:w-1/3">
                <img
                  ...
                  className="w-full rounded-lg shadow-md"
                />
                <p className="mt-2 text-center text-gray-600">Wall Push-Ups</p>
              </div>
              <div className="w-full sm:w-1/2 lg:w-1/3">
                <img
